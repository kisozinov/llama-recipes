...
from llama_recipes.datasets.smm_dataset import get_custom_dataset as get_smm_dataset
from llama_recipes.datasets.amazon_dataset import get_custom_dataset as get_amazon_dataset